 ...
 * @author Luca Garulli
 */
@SuppressWarnings("unchecked") public class ODatabaseDocumentTxOrig extends OListenerManger<ODatabaseListener>
   ...
   */
  @Override public ODatabaseDocumentTxOrig activateOnCurrentThread() {
